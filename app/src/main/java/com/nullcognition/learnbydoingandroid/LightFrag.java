 ...
 * {@link LightFrag.OnFragmentInteractionListener} interface
...
public class LightFrag extends Fragment {
    ...
    public static LightFrag newInstance() {
    ...
    public void onInteraciton(int light) {
        if (mListener != null) {
	        String s = "this is the frag to activity";
